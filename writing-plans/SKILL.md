...
- **Enforced execution model:- **Verification:** how will we prove it works? (e.g., specific test commands)
- **Tracking:** update your `<appDataDir>/brain/<conversation-id>/task.md` artifact
