...
4. If no concerns: follow the single-flow execution
5. Commit with `/commit "feat: specific part"` when verifying it works
6. Update your `<appDataDir>/brain/<conversation-id>/task.md` artifact and proceed
